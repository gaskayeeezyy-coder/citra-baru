...
const CAPSULE_CONFIG = {
    ...
    finalLetterText: "aku cuman mau bilang kalo aku minta maaf akhir akhir ini aku cuek sama kamu. hehehe i love you so much",
    closingMessage: "Terima kasih sudah membaca semuanya."
};
